...
public class SUVEntry extends JFrame implements ActionListener {
    ...
    private SUVListing suvListing;
    private JPanel pnlCommand;
    private JPanel pnlDisplay;

    public SUVEntry(SUVListing suvListing) {
        this.suvListing = suvListing;
        
            setTitle("Entering new SUV");
            ...
            pnlFourWheelDrive.add(new JLabel("Four-Wheel Drive:"));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == cmdClose) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(suvListing, "Year and Price must be numbers.");
                return;
            }
            ...
            try {
                suvListing.addSUV(new SUV(make, model, year, price, fourWheelDrive, otherFeatures));
                this.setVisible(false);
            } catch (NumberFormatException nfe) {
                System.out.println("Year and Price must be a number.");
